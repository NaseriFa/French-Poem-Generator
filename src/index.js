...
function generatePoem(event){
  ...
  let context = "You are a romantic French poem generator. Write a short 4-line poem using simple HTML. Do not show HTML tags to the user. End with '<strong>SheCodes AI</strong>' and separate each line with a <br/>.";
